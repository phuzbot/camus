...
func (tc *testClient) checkDeployBody(deployId string, path string, expected string) {
...
func TestRun(t *testing.T) {
	...
	deployId := client.Push()
	client.Run(deployId)
	client.checkDeployBody(deployId, "", "Hello World!")
}
...
func TestPidRun(t *testing.T) {
	...
	deployId := client.Push()
	client.Run(deployId)
	client.checkDeployBody(deployId, "", expected)
...
func TestHaproxy(t *testing.T) {
	...
	client.checkDeployBody(v1DeployId, "/file", "version 1")
	client.checkDeployBody(v2DeployId, "/file", "version 2")
